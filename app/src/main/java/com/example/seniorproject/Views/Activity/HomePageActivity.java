...
//        mapFragment.getMapAsync(this);
        ...
        Fragment homepageFragment = fragmentManager.findFragmentById(R.id.homepage_fragment_container);

        if (homepageFragment == null) {

            homepageFragment = new HomePageFragment();
            fragmentManager.beginTransaction().add(R.id.homepage_fragment_container, homepageFragment).commit();
        }
